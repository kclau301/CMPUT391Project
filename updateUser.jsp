...
if (checkClass.equals("a")){
	if (request.getParameter("SEARCH").equals(request.getParameter("user"))) {
		...
		String sqlStatement = "select password, class, person_id from users where user_name = '"+ username +"'";
		...
		try {
			...
			out.println("Person ID: <input type=text name=PERSONID value="+personID+"><br>");
		...
		try {
			...
			out.println("<input type=hidden name=PERSONID value="+personID+">");
                	out.println("</form>");
			conn.close();
		} catch(Exception e) {
			out.println("<hr>" + e.getMessage() + "<hr>");
		...
		try {
			...
			out.println("<input type=hidden name=PATID value="+personID+">");
                	out.println("</form>");
			conn.close();
		} catch(Exception e) {
