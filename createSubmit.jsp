...
<BODY>
	...
	<%@ page
		import="java.sql.*, java.util.Date, java.text.SimpleDateFormat, db.Database"%>
	<%
		...
		if (checkClass.equals("a")) {
			if (request.getParameter("create").equals(
				...
				Date date = new Date();
				String dateStr = new SimpleDateFormat("MM/dd/yyyy")
						.format(date);

				String insertStr = "INSERT INTO users VALUES('" + username
						+ "', '" + password + "', '" + classStr + "', '"
						+ personID + "', to_date('" + dateStr
						+ "', 'MM/DD/YYYY'))";
			...
			} else if (request.getParameter("create").equals(
				...
				try {
					...
					personID++;
					insertStr = "INSERT INTO persons VALUES(" + personID
							+ ", '" + firstName + "', '" + lastName
							+ "', '" + address + "', '" + email + "', '"
							+ phone + "')";
					stmt.executeUpdate(insertStr);
				...
				String insertStr = "INSERT INTO family_doctor VALUES("
						+ docID + ", " + personID + ")";
